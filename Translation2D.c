...
int main(int argc, char **argv) {
    ...
    if (nVerts <= 2 || nVerts > MAX_VERTS) {
        printf("Error: Number of vertices must be between 3 and %d.\n", MAX_VERTS);
        return 1;
    }
    ...
    glutCreateWindow("2D Polygon Translation with User Input");
